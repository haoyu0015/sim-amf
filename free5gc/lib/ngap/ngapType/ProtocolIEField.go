...
type GlobalRANNodeIDExtIEsValue struct {
	Present      int
	GlobalWAGFID *GlobalWAGFID `aper:"referenceFieldValue:242,valueLB:0,valueUB:3"`
	//GlobalTNGFID 	*GlobalTNGFID  `aper:"referenceFieldValue:240"`
	//GlobalTWIFID 	*GlobalTWIFID  `aper:"referenceFieldValue:241"`
}
...
const (
	...
	UserLocationInformationExtIEsPresentWAGF
	//UserLocationInformationExtIEsPresentTNGF
	//UserLocationInformationExtIEsPresentTWIF
)

type UserLocationInformationExtIEsValue struct {
	Present                     int
	UserLocationInformationWAGF *UserLocationInformationWAGF `aper:"referenceFieldValue:243,valueLB:0,valueUB:3"`
	//UserLocationInformationTNGF *UserLocationInformationTNGF  `aper:"referenceFieldValue:246"`
	//UserLocationInformationTWIF *UserLocationInformationTWIF  `aper:"referenceFieldValue:247"`
}
...
const (
	...
	PDUSessionResourceSetupRequestIEsPresentPDUUEAggregateMaximumBitRate
)
...
type UplinkNASTransportIEsValue struct {
	...
	NASPDU                  *NASPDU                  `aper:"referenceFieldValue:38"`
	UserLocationInformation *UserLocationInformation `aper:"referenceFieldValue:121,valueLB:0,valueUB:3"`
	WAGFIdentityInformation *aper.OctetString        `aper:"referenceFieldValue:239,valueLB:0,valueUB:3"`
}
