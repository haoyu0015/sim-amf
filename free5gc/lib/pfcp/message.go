...
type PFCPSessionEstablishmentRequest struct {
	CasaLBUSliceID           *pfcpType.CasaLBUSliceID           `tlv:"32782"`
	NodeID                   *pfcpType.NodeID                   `tlv:"60"`
...
type DHCPV4Message struct {
	CasaLBUSliceID *pfcpType.CasaLBUSliceID `tlv:"32782"`
	CasaDHCPV4Pkt  *pfcpType.CasaDHCPv4     `tlv:"32787"`
}
type DHCPV6Message struct {
	CasaLBUSliceID *pfcpType.CasaLBUSliceID `tlv:"32782"`
	CasaDHCPV6Pkt  *pfcpType.CasaDHCPv6     `tlv:"32788"`
}
type RouterSolicitMessage struct {
	CasaLBUSliceID *pfcpType.CasaLBUSliceID `tlv:"32782"`
	CasaICMPV6Pkt  *pfcpType.CasaICMPv6     `tlv:"32789"`
}
type PPPoEMessage struct {
	Pkt *[]byte
}
type DataPacketMessage struct {
	Pkt *[]byte
}
