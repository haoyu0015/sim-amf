...
func (protocolConfigurationOptions *ProtocolConfigurationOptions) AddIPv4AddressAllocationViaDHCPv4() {
	protocolOrContainerUnit := NewProtocolOrContainerUnit()

	protocolOrContainerUnit.ProtocolOrContainerID = nasMessage.IPv4AddressAllocationViaDHCPv4UL
	protocolOrContainerUnit.LengthOfContents = 0
